use crate::{BUILTIN_THEMES, colors::Theme, config::THEMES_DIR};

/// Try to read a color theme from the configuration directory
pub fn read_theme_from_config(theme: &str) -> Option<Theme> {
...
pub fn get_theme(theme_name: &str) -> Option<Theme> {
